...
from app.ui.mini_games_tool import MiniGamesTool
...
from app.ui.geospatial_tool import GeospatialTool 
from app.ui.format_converter_tool import FormatConverterTool 
...
class IntegratedTool:
    ...
    def create_notebook(self):
        ...
        self.mini_games_frame = ttk.Frame(self.notebook)
        ...
        self.geospatial_frame = ttk.Frame(self.notebook)
        self.format_converter_frame = ttk.Frame(self.notebook)

        
        # 添加选项卡（计算选项卡作为第一个，小游戏作为第二个）
        self.notebook.add(self.calculation_frame, text="计算")
        self.notebook.add(self.mini_games_frame, text="小游戏")
        ...
        # 初始化小游戏工具界面
        self.mini_games_tool = MiniGamesTool(self.mini_games_frame, self.theme)
        ...
        # 初始化地理空间工具
        self.geospatial_tool = GeospatialTool(self.geospatial_frame, self.theme)
        
        # 初始化格式转换工具
        self.format_converter_tool = FormatConverterTool(self.format_converter_frame, self.theme)
...
from .image_gps_extractor.gps_extractor_tab import GPSExtractorTab

class ImageGPSExtractorTool:
    """图片GPS提取工具主类"""
    ...
    def create_widgets(self):
        ...
        title_label = tk.Label(title_frame, text="图片GPS提取工具", 
        ...
        instruction_text = "图片GPS提取工具：扫描文件夹中的图片，提取GPS坐标信息，支持导出Excel和批量重命名功能。"
    ...
    def create_notebook(self):
        ...
        # GPS提取选项卡
        extractor_frame = tk.Frame(self.notebook, bg=self.theme.bg_color)
        self.notebook.add(extractor_frame, text="GPS提取")
        
        # 创建GPS提取功能模块
        self.extractor_tab = GPSExtractorTab(extractor_frame, self.theme)
